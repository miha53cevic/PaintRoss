...
import PenTool from "../rosslib/tools/pen";
    ...
    return (
        <div className="absolute top-[88px] left-4 bg-slate-950 rounded-2xl flex flex-col items-center p-4 gap-4 text-slate-400">
            ...
            <div className="flex flex-col gap-4">
                <button className={`border-none rounded ${IsSelectedTool('Pen') ? 'bg-slate-600' : ''}`} onClick={() => PaintApp.Get().SetTool(PaintApp.Get().HelperCreateTool((gl, canvasObj) => new PenTool(gl, canvasObj)))}>Pen</button>
